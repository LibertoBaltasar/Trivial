...
public class Constantes {
    public static String mensajeInicio="Bienvenido";
    public static String mensajeSeleccionPartida="Has seleccionado la opción Jugar Partida";
    public static String mensajeSeleccionRanking="Has seleccionado la opción Ranking";
